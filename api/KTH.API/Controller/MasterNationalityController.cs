...
namespace KTH.API.Controller
{
    ...
    public class MasterNationalityController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterNationalityService _service;

        public MasterNationalityController(IConfiguration configuration, IMasterNationalityService service)
        {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterNationalityRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterNationalityListResponse Outbound = new MasterNationalityListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            MasterNationalityResponse Outbound = new MasterNationalityResponse();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMasterNationalityRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateMasterNationalityRequest request)
        {
            ResponseModel resp = new ResponseModel();
