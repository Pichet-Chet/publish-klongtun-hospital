...
namespace KTH.API.Controller
{
    ...
    public class MasterThaiDistrictController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterThaiDistrictService _service;

        public MasterThaiDistrictController(IConfiguration configuration, IMasterThaiDistrictService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterThaiDistrictRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterThaiDistrictListResponse Outbound = new MasterThaiDistrictListResponse();
            ...
            try
            {
                ...
                if (Outbound.Data != null)
                {
                    ...
                    resp.Rows = await _service.CountAllAsync(param.ProvinceId);
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            MasterThaiDistrictResponse Outbound = new MasterThaiDistrictResponse();
