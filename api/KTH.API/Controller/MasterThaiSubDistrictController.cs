...
namespace KTH.API.Controller
{
    ...
    public class MasterThaiSubDistrictController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterThaiSubDistrictService _service;

        public MasterThaiSubDistrictController(IConfiguration configuration, IMasterThaiSubDistrictService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterThaiSubDistrictRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterThaiSubDistrictListResponse Outbound = new MasterThaiSubDistrictListResponse();
            ...
            try
            {
                ...
                if (Outbound.Data != null)
                {
                    ...
                    resp.Rows = await _service.CountAllAsync(param.DistrictId);
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            MasterThaiSubDistrictResponse Outbound = new MasterThaiSubDistrictResponse();
