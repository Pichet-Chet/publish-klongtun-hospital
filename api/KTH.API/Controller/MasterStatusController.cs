...
namespace KTH.API.Controller
{
    ...
    public class MasterStatusController : ControllerBase
    {
        ...
        public MasterStatusController(IConfiguration configuration, IMasterStatusService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterStatusRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterStatusListResponse Outbound = new MasterStatusListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            MasterStatusResponse Outbound = new MasterStatusResponse();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMasterStatusRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateMasterStatusRequest request)
        {
            ResponseModel resp = new ResponseModel();
