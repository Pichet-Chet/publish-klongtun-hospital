...
using KTH.MODELS.Custom.Request.CreateMasterReferral;
...
namespace KTH.API.Controller
{
    ...
    public class MasterReferralFromController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterReferralFromService _service;

        public MasterReferralFromController(IConfiguration configuration, IMasterReferralFromService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterReferralFromRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterReferralFromListResponse Outbound = new MasterReferralFromListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            MasterReferralFromResponse Outbound = new MasterReferralFromResponse();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMasterReferralFromRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateMasterReferralFromRequest request)
        {
            ResponseModel resp = new ResponseModel();
