...
namespace KTH.API.Controller
{
    ...
    public class MasterRightTreatmentController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterRightTreatmentService _service;

        public MasterRightTreatmentController(IConfiguration configuration, IMasterRightTreatmentService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterRightTreatmentRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterRightTreatmentListResponse Outbound = new MasterRightTreatmentListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            MasterRightTreatmentResponse Outbound = new MasterRightTreatmentResponse();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMasterRightTreatmentRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateMasterRightTreatmentRequest request)
        {
            ResponseModel resp = new ResponseModel();
