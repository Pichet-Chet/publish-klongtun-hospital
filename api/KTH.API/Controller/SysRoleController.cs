...
namespace KTH.API.Controller
{
    ...
    public class SysRoleController : ControllerBase
    {
        ...
        public SysRoleController(IConfiguration configuration, ISysRoleService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterSysRoleRequest param)
        {
            ResponseModel resp = new ResponseModel();

            SysRoleListResponse Outbound = new SysRoleListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            SysRoleResponse Outbound = new SysRoleResponse();
        ...
        [HttpGet]
        [Route("byName/{name}")]
        public async Task<IActionResult> GetByRoleId(string name)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateSysRoleRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateSysRoleRequest request)
        {
            ResponseModel resp = new ResponseModel();
