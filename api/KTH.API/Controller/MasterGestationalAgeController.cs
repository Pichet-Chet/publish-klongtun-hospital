...
namespace KTH.API.Controller
{
    ...
    public class MasterGestationalAgeController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IMasterGestationalAgeService _service;

        public MasterGestationalAgeController(IConfiguration configuration, IMasterGestationalAgeService service)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] FilterMasterGestationalAgeRequest param)
        {
            ResponseModel resp = new ResponseModel();

            MasterGestationalAgeListResponse Outbound = new MasterGestationalAgeListResponse();
        ...
        public async Task<IActionResult> GetById(string id)
        {
            ...
            MasterGestationalAgeResponse Outbound = new MasterGestationalAgeResponse();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateMasterGestationalAgeRequest request)
        {
            ResponseModel resp = new ResponseModel();
        ...
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] UpdateMasterGestationalAgeRequest request)
        {
            ResponseModel resp = new ResponseModel();
