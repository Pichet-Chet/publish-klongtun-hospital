...
{
    public class GetTransClientFilterResponse
    {
        public List<GetTransClientFilterResponseData> Data { get; set; }
        public MessageAlertResponse MessageAlert { get; set; }
    }

    public class GetTransClientFilterResponseData
    {
        public GetTransClientFilterResponseData()
        {
            TransClienHeader = new TransClienHeader();
        }
        ...
        public TransClienHeader TransClienHeader { get; set; }
    }

    public class TransClienHeader
    {
