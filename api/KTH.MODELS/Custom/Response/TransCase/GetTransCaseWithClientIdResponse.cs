...
{
    public class GetTransCaseWithClientIdResponse
    {
        public List<GetTransCaseWithClientIdResponseData> Data { get; set; }
        public MessageAlertResponse MessageAlert { get; set; }
    }

    public class GetTransCaseWithClientIdResponseData
    {
        public GetTransCaseWithClientIdResponseData()
        {
            TransClientData = new TransClientData();
        }
        ...
        public TransClientData TransClientData { get; set; }
    }

    public class TransClientData
    {
