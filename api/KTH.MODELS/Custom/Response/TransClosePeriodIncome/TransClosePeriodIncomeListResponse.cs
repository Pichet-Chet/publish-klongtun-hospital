...
{
    public class TransClosePeriodIncomeListResponse
    {
        public TransClosePeriodIncomeListResponse()
        {
            MessageAlert = new MessageAlertResponse();
        }

        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public List<TransClosePeriodIncomeListResponseData>? Data { get; set; }

        public MessageAlertResponse MessageAlert { get; set; }
    }

    public class TransClosePeriodIncomeListResponseData
    {
